...
print("Целочисленное приведение чисел отбрасывает дробную часть, если она есть. Числа двойной точности оставляют дробную часть, в связи с этим происходят более точные вычисление")
